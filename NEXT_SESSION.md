...
1. ~~Run the pre-1998 price fetch~~ **DONE in v8 (run 14)**: 181 events captured (156 full brackets, 25 recorded HTTP-400 failures — ALC pre-2019 ADR, RHHBY 1980s-90s OTC ADRs, ORPH, SNY early-90s ADRs — never retried with successor tickers); `data/stock_price_snapshots.csv` 153 → 334, core table 145 → 301 priced. Still open from v7: 76 failed requests in `data/raw/stock_yahoo_events_1998_2026/` stay failed.
