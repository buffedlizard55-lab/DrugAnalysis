...
def era_rows(final_rows: list[dict]) -> list[dict]:
    ...
    fixed = {
        ...
        "1983": {
            ...
            "historical_significance": "Pink Sheet reporting pinned 14 NMEs for 1983; Drugs@FDA indexes 13 TYPE-1 applications. The table tracks those 13 plus the separately verified Furosemide oral-solution original application, whose chemical type/priority are not stated.",
        ...
        "1984": {
            ...
            "historical_significance": "Drugs@FDA indexes 19 TYPE-1/1-4 original applications; the table tracks all 19 plus Trandate's separately verified TYPE-5 new-manufacturer application. The older unpinned secondary '22 NMEs' figure remains flagged rather than repeated as fact.",
        ...
        "1985": {
            ...
            "historical_significance": "Record post-1962 drug approval count of 31 NMEs per FDA's CDER NME Compilation; the existing master contains all 31, with four COMPILATION_ONLY rows documented in the verification report.",
