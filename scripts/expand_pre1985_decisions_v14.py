...
def era_rows(final_rows: list[dict]) -> list[dict]:
    ...
    fixed = {
        "1980": {
            ...
            "historical_significance": "The committed Drugs@FDA extract enumerates nine TYPE-1 original approvals. This is an application-level enumeration, not a claimed contemporaneous CDER annual NME statistic; no official pre-1985 annual NME table was located.",
        ...
        "1981": {
            ...
            "historical_significance": "The committed Drugs@FDA extract enumerates 23 TYPE-1/1-4 original approvals. This transparent application-level count must not be presented as a reconstructed contemporaneous annual NME statistic.",
        ...
        "1982": {
            ...
            "historical_significance": "The committed Drugs@FDA extract enumerates 25 TYPE-1 original applications, including the first recombinant-DNA pharmaceutical approval cohort. The count is explicitly an application-level enumeration, not a claimed CDER annual NME statistic.",
        ...
        "1985": {
            ...
            "historical_significance": "Record post-1962 drug approval count of 31 NMEs per FDA's CDER NME Compilation; the existing master contains all 31, with four COMPILATION_ONLY rows documented in the verification report. v15 (2026-09-18) boundary audit: all 82 ORIG/AP payload decisions for 1985 are accounted for (27 master TYPE 1/1-4 matches + Temovate's companion TYPE 3 NDA019323 via the Compilation cross-reference + 54 published non-NME originals); the four master applications openFDA cannot enumerate (Seldane, Protropin, Suprol, Femstat) are pinned as a documented Drugs@FDA completeness gap in data/focus_years_1983_1985_audit.csv.",
    ...
    fields = [
        "year", "total_nmes_approved", "verified_decisions_tracked", "priority_reviews",
