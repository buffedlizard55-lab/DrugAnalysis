...
def resolve(applicant):
    ...
    a = a.split("(")[0]  # ignore parenthetical context; match the primary applicant only
...
for r in rows_out:
    ...
    new_rows.append({
        ...
        "source_url_1": json.load(open(STG / r["src"]))["capture_url"] if r["src"].endswith(".json") else "https://goldwaterinstitute.org/wp-content/uploads/2018/11/2017-New-Drug-Therapy-Approvals.pdf",
