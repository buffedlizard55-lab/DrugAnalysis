# Verification Report — Clinical Trial & Regulatory Scorecard — v9 Sep 2026

**Date:** 2026-09-18 v9 (this session)
**Branch:** `arena/01a0b255-druganalysis`
**Validator:** `python3 scripts/validate_data.py` — PASS (1,427 novel-approval rows **1985–2026**, 4,482 efficacy supplements, 2,798 original non-NME rows 1985–2026, 100 orig scorecards, 11 Type-1-gap flags (all adjudicated), 99 label-expansion scorecards, 1,427 cross-check rows, 750 company scorecards, **978 price snapshots**, 458 CRLs, 2,000 CT.gov Phase 3 records, 402 clinical-trial scorecards, **204 pre-2000 audit rows**, **67 sponsor-resolution worklist rows**, **16 era-analysis rows**; review warnings are the intended FLAGGED items, 0 errors). New v9 assertions: pre-2000 audit coverage + year pins + verdict floor, dead-Wayback-timestamp ban, pathway spelling/blank rules, snapshot uniqueness + 1998–2000 ingestion floors, sponsor-index schema, era-analysis agreement with the master.

## Summary — this session (v9): pre-2000 year-by-year audit 2000→1996 + price-ingestion bug fix + pathway consistency
