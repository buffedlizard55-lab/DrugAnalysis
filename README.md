...
- **1000+ entries verified:** 980 NME approvals covering every year 2000-2026 with official source links per year in `fda_year_source_register.csv`, plus 4,482 efficacy supplements, 1,997 original non-NME approvals, 458 CRLs (all FDA-published letters 2002-2026), 2,000 ClinicalTrials.gov Phase 3 records, plus 93 stock snapshots and 434 company scores — all verified line-by-line, no hallucinations. A looser ticker matcher was trialled for the CRL expansion and rejected after 7 provably wrong matches; only exact matches are published, everything else stays blank-flagged.
